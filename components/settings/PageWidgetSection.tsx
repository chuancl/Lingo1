             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                   ...
                   <div className="grid grid-cols-2 gap-2 mb-4">
                      <label className="flex items-center p-2 border border-slate-100 rounded bg-slate-50 cursor-pointer">
                         ...
                         <span className="text-sm font-medium text-slate-700">显示音标 (固定位置)</span>
                      </label>
                      <label className="flex items-center p-2 border border-slate-100 rounded bg-slate-50 cursor-pointer">
                         ...
                         <span className="text-sm font-medium text-slate-700">显示释义 (固定位置)</span>
                      </label>
                   </div>
